...
unique template rpms/system_management_snmp;
...
"/software/packages"=pkg_repl("net-snmp-perl","5.5-44.el6","x86_64");
"/software/packages"=pkg_repl("net-snmp-python","5.5-44.el6","x86_64");
