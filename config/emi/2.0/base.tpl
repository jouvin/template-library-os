...
'/software/packages' = pkg_repl('perl-SOAP-Lite','0.710.10-3.el6','noarch');
...
'/software/packages'=pkg_repl('perl-GSSAPI','0.26-6.el6',PKG_ARCH_GLITE);
...
'/software/packages'=pkg_repl('libstdc++','4.4.7-3.el6',PKG_ARCH_GLITE);
...
'/software/packages' = pkg_repl('tkinter','2.6.6-36.el6', PKG_ARCH_DEFAULT);
...
'/software/packages'=pkg_repl('libgcj','4.4.7-3.el6',PKG_ARCH_DEFAULT);
'/software/packages'=pkg_repl('libgcj-devel','4.4.7-3.el6',PKG_ARCH_DEFAULT);
