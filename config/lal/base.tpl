...
# Add cups
"/software/packages"=pkg_repl('cups','1.4.2-48.el6_3.3',PKG_ARCH_DEFAULT);
"/software/packages"=pkg_repl('cups-libs','1.4.2-48.el6_3.3',PKG_ARCH_DEFAULT);
...
# Add NIS client
"/software/packages"=pkg_repl("ypbind","1.20.4-30.el6","x86_64");
...
"/software/packages"=pkg_repl('libpciaccess','0.13.1-2.el6',PKG_ARCH_DEFAULT);
"/software/packages"=pkg_repl('libproxy','0.3.0-4.el6_3',PKG_ARCH_DEFAULT);
"/software/packages"=pkg_repl('libproxy-bin','0.3.0-4.el6_3',PKG_ARCH_DEFAULT);
"/software/packages"=pkg_repl('libproxy-python','0.3.0-4.el6_3',PKG_ARCH_DEFAULT);
