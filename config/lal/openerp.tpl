...
'/software/packages'=pkg_repl('python-psycopg2','2.0.14-2.el6','x86_64');
...
'/software/packages'=pkg_repl('openssl','1.0.0-27.el6','x86_64');
...
'/software/packages'=pkg_repl('postgresql-server','8.4.13-1.el6_3','x86_64');
