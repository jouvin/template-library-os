...
'/software/packages' = pkg_repl('perl','5.10.1-129.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-Compress-Raw-Zlib','2.020-129.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-GSSAPI','0.26-6.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-IO-Compress-Base','2.020-129.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-IO-Compress-Zlib','2.020-129.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-Module-Pluggable','3.90-129.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-Pod-Escapes','1.04-129.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-Pod-Simple','3.13-129.el6',PKG_ARCH_DEFAULT);
...
'/software/packages' = pkg_repl('perl-libs','5.10.1-129.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-libwww-perl','5.833-2.el6','noarch');
'/software/packages' = pkg_repl('perl-version','0.77-129.el6',PKG_ARCH_DEFAULT);

# CCM 3.x dependencies
'/software/packages' = pkg_repl('perl-CGI','3.51-129.el6',PKG_ARCH_DEFAULT);
'/software/packages' = pkg_repl('perl-parent','0.221-129.el6',PKG_ARCH_DEFAULT);
