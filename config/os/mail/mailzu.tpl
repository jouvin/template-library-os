...
'/software/packages'=pkg_repl('php','5.3.3-22.el6','x86_64');
'/software/packages'=pkg_repl('php-cli','5.3.3-22.el6','x86_64');
'/software/packages'=pkg_repl('php-imap','5.3.3-22.el6','x86_64');
'/software/packages'=pkg_repl('php-mysql','5.3.3-22.el6','x86_64');
'/software/packages'=pkg_repl('php-devel','5.3.3-22.el6','x86_64');
